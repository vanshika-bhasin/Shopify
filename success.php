...
<html lang="en">
    <head>
        <title>Success Shopify</title>
        <meta charset="UTF-8">
        <meta name="description" content="Shopify, India's fashion e-store."/>
        ...
        <div id="banner_image" style="height: 620px;margin-bottom: 0px;">
            <div class="container">
                <div class="jumbotron" style="margin-top: 200px;background-color: rgba(0, 0, 0, 0.7);">
                    ...
                    <p>Thank you for shopping with us. <a href="product.php">Click here</a> to purchase other products</p>
                </div>
            </div>   
        </div>
        <?php
